        ...
        <div className="w-full flex flex-col gap-6 justify-start items-center">
          ...
          <div className="w-full flex flex-col gap-4">
            <div className="flex justify-between items-center w-full">
              ...
              <button className="p-1 rounded hover:bg-gray-700 transition-colors">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="text-[#d0de27]">
                  <path
                  ...
                  />
                  <path
                    d="M13 8C13 8 11.5 11 8 11C4.5 11 3 8 3 8C3 8 4.5 5 8 5C11.5 5 13 8 13 8Z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <input
                  ...
                  className={`flex-1 bg-transparent outline-0 ${isDarkMode ? 'text-white' : 'text-[#000]'} no-spinner ${
